...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index"><img  style="width:90px;" src="/img/logo.png"/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link"  href="{{route('rider.packages')}}">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link"  href="{{route('rider.mytrips')}}">
            ...
            <span class="nav-link-text">My Trips</span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
	  ...
	  <!-- <iframe name="contentFrame" frameborder="0" width="100%" height="1500px" src="dashboard"></iframe> -->
	   @yield('content')
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © TripRider 2018</small>
        </div>
      </div>
    </footer>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="/../Common/index">Logout</a>
          </div>
        </div>
      </div>
    </div>
	...
	<div class="modal fade" id="settingsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Navbar Settings</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
		  ...
		  <button class="btn btn-primary" href="#" id="toggleNavPosition">Toggle Fixed/Static Navbar</button>
